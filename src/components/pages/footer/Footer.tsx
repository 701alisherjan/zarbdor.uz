...
export default function Footer() {
  return (
    <footer className="w-full border-t bg-white text-gray-700 mt-10">
        ...
        <div className="flex flex-col gap-5">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 flex items-center">
             <img src="https://png.pngtree.com/png-vector/20230209/ourmid/pngtree-letter-z-logo-png-image_6590691.png" alt="Zarbdor.uz" className="h-7 w-auto"/> <span>ARBDOR.uz</span>
            </div>
          </div>
          ...
          <p className="text-sm leading-6 max-w-lg">
            ZARBDOR.UZ — ommaviy axborot vositasi sifatida 2018-yil 26-oktabr kuni
            O'zbekiston Respublikasi Prezident Administratsiyasi huzuridagi Axborot
            va ommaviy kommunikatsiyalar agentligida 1089-raqam bilan ro'yxatdan o'tgan.
            <br /><br />
        ...
        <div className="flex flex-col gap-10">
          ...
          <div className="flex flex-col gap-6 items-start">
            <div className="flex gap-3">
              <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRoYdy2g2kwE1kJslTy35uMWayAE5iYwg1TlA&s" alt="App Store" className="h-10" />
